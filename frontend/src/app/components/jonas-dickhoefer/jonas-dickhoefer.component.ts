...
@Component({
  selector: 'app-jonas-about',
  standalone: true,
  templateUrl: './jonas-dickhoefer.component.html',
  styleUrls: ['./jonas-dickhoefer.component.css'],
})
export class JonasComponent implements OnInit {
  ...
  ngOnInit(): void {
     ...
     *
     *
     *  ====== Optional / für erfahrenere Entwickler*innen ======
     *
     ...
     *  ).subscribe(....)
     *
     *  Weiterführende Links (Optional / für erfahrenere Entwickler*innen)
     *  - https://www.learnrxjs.io/
     *  - https://rxmarbles.com/
     */
    this.aboutService.getJonasInfo().subscribe({
